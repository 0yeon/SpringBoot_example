...
//
//@Controller
//// ¹®ÀÚ¿­À» º¸¿©ÁÜ (ResponseBody ¾È½áµµµÊ)
//@RestController
//@RequestMapping("test")
//public class TestController {
//	@GetMapping
//	public String getDefault() {
////		TodoEntity todo = TodoEntity.builder().id("park").userId("LEE").title("¹ä¸Ô±â").build();
//		
//		TodoEntity todo = new TodoEntity("a", "kim", "°øºÎ", false);
...
//	}
//	
////	// RequestBody -> JSON Çü½ÄÀ¸·Î °´Ã¼¸¦ ¹Þ¾Æ¿È
...
public class TestController {
   ...
   @GetMapping
   public String getDefault() {
      //TodoEntity todo = TodoEntity.builder().id("lee001").userId("LEE").title("¹ä¸Ô±â").build();
      TodoEntity todo = new TodoEntity("a001", "KIM", "°øºÎÇÏ±â", false);
      return todo.toString();
   }
